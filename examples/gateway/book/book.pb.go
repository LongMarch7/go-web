...
var fileDescriptor_b052b9cede179df0 = []byte{
	...
	,
}
...
type BookServiceClient interface {
	...
	PostBookInfo(ctx context.Context, in *BookInfoParams, opts ...grpc.CallOption) (*BookInfo, error)
	PostBookList(ctx context.Context, in *BookListParams, opts ...grpc.CallOption) (*BookList, error)
}
...
func (c *bookServiceClient) PostBookInfo(ctx context.Context, in *BookInfoParams, opts ...grpc.CallOption) (*BookInfo, error) {
	out := new(BookInfo)
	err := c.cc.Invoke(ctx, "/book.BookService/PostBookInfo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *bookServiceClient) PostBookList(ctx context.Context, in *BookListParams, opts ...grpc.CallOption) (*BookList, error) {
	out := new(BookList)
	err := c.cc.Invoke(ctx, "/book.BookService/PostBookList", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BookServiceServer interface {
	...
	PostBookInfo(context.Context, *BookInfoParams) (*BookInfo, error)
	PostBookList(context.Context, *BookListParams) (*BookList, error)
}
...
func (*UnimplementedBookServiceServer) PostBookInfo(ctx context.Context, req *BookInfoParams) (*BookInfo, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PostBookInfo not implemented")
}
func (*UnimplementedBookServiceServer) PostBookList(ctx context.Context, req *BookListParams) (*BookList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PostBookList not implemented")
}
...
func _BookService_PostBookInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BookInfoParams)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookServiceServer).PostBookInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/book.BookService/PostBookInfo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookServiceServer).PostBookInfo(ctx, req.(*BookInfoParams))
	}
	return interceptor(ctx, in, info, handler)
}

func _BookService_PostBookList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BookListParams)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookServiceServer).PostBookList(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/book.BookService/PostBookList",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookServiceServer).PostBookList(ctx, req.(*BookListParams))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _BookService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "PostBookInfo",
			Handler:    _BookService_PostBookInfo_Handler,
		},
		{
			MethodName: "PostBookList",
			Handler:    _BookService_PostBookList_Handler,
		},
	},
